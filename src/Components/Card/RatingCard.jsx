...
const Card = () => {
  ...
  const {handlerating, handlesetShowRating, disable} = useContext(RatingContext)
    ...
    <>
      <div className={styles.cardWrapper}>
        ...
        <div className={styles.submit}>
          <button disable={disable} className={styles.submitButtom} onClick={handlesetShowRating}>Submit</button>
        </div>
      </div>
    </>
  );
