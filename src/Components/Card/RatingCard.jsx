...
const Card = () => {
  ...
  const { handlerating, handlesetShowRating, isSubmitDisabled, buttonText } = useContext(RatingContext)
    ...
    <>
      ...
      <footer className={styles.att}>
        <code>
          ...
          Coded by <a href="https://github.com/maicondguerian"> maicondlol</a>.
        </code>
      </footer>
    </>
  );
